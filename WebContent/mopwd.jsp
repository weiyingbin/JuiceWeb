					...
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
							<div class="box p-40 p-xs-20 bg-white">
								<form action="mopwd.action" method="post">
								
								    <div class="form-group">
										<label class="control-label" for="input-email">请输入旧密码</label>
										<input type="password" name="opwd" id="input-email" class="form-control form-item">
									</div>
									<div class="form-group">
										<label class="control-label" for="input-email">请输入新密码</label>
										<input type="password" name="pwd1" id="input-email" class="form-control form-item">
									</div>
									<div class="form-group m-t-30">
										<label class="control-label" for="input-password">确认新密码</label>
										<input type="password" name="pwd2" value="" placeholder="Password" id="input-password" class="form-control form-item">
										<a class="m-b-30" href="#">忘记密码</a>
									</div>
									<input type="submit" class="btn ht-btn bg-6" value="确定">
