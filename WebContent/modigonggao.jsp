...
<form action="modinewgonggao.action" method="post">                 
  <div>
  <table border="0" width="100%" heigth="100%" cellspacing="15px">
  <tr style="heigth:200px">
 <td colspan="2" style="heigth:200px"> <img src="Itempicture/${xxgonggao.gphoto}" style="width:200px;heigth:200px"></td>
 </tr>
 ...
 <td colspan="2" style="heigth:200px"></td>
  ...
  <tr>
  <td>公告主题：</td>
  <td><input type="text" name="newgname" style=" width:400px" value="${xxgonggao.gname}"/></td>
  </tr>
 ...
 <td colspan="2" style="heigth:200px"></td>
  ...
  <tr>
  <td>详细内容：</td>
  <td><textarea rows="6" cols="48" name="newgneirong">${xxgonggao.gneirong}</textarea></td>
  </tr>
 ...
 <td colspan="2" style="heigth:200px"><div id="div1" >${errorinfo}</div></td>
  ...
  <tr>
  <input type="hidden" name="newgid" value="${xxgonggao.gid}" />
