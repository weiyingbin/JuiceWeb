	...
	<div class="banner-body">
		<div class="container">
						...
						<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
							<nav class="stroke">
								<ul class="nav navbar-nav">
									...
									<li class="active"><a href="blog.jsp"><i class="edit"></i>个人博客</a></li>
									<li ><a href="updateblog.jsp"><i class="edit"></i>写博客</a></li>
									</ul>
							</nav>
						</div>
						<!-- /.navbar-collapse -->
			...
			<div class="col-xs-9 banner-body-right">
				...
				<div class="banner-bottom">
					<div class="col-md-4 banner-left">
						...
						<p>发挥你的想象，让原本单调的食材成为别人的眼中让人垂涎欲滴的食物。让原本一个味道的食材，经过你之手，构成另一种风味，在你的舌尖舞动！</p>
					</div>
					  ...
					  <div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingOne">
						  <h4 class="panel-title">
							...
							${ personcomment1.uname}
							</a>
						  </h4>
						</div>
						<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
						  <div class="panel-body">
							${ personcomment1.detalis}
						  </div>
						</div>
					  </div>
			...
			<div class="col-xs-9 banner-body-right">
				...
				<div class="blog">
				<c:forEach items="${personblog}" var="per">
					<div class="blog-grid">
						<div class="col-xs-4 blog-grid-left">
							<a href="/dcxy/singlephoto?phoid=${per.id}"><img src="picture/${per.photo}" alt=" " class="img-responsive" /></a>
						</div>
						<div class="col-xs-8 blog-grid-right">
							<h4><a href="single.html">${per.title}</a></h4>
							<p>${per.details}</p>
							
							<a href="/dcxy/singlephoto?phoid=${per.id}"><span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span></a>
						<div class="col col-xs-2"><a href="/dcxy/deleteblog?blogId=${per.id}" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></div>
