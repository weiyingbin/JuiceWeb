...
<html lang="zxx">
 ...
 <table border=0 bgcolor=F56C45  width="500" >
    <thead>
    	<tr>
        	<th scope="col" bgcolor=F56C45 width="100" >  </th>
            <th scope="col" bgcolor=F56C45  >日期</th>
            <th scope="col" bgcolor=F56C45  >评论页面</th>
            <th scope="col" bgcolor=F56C45  >内容</th>
            
            <th scope="col" bgcolor=F56C45  >删除</th>
        </tr>
    </thead>
    ...
    <c:forEach items="${pinglun}" var="pinglun">
    	<tr>    	
        	<td><img src="Itempicture/${pinglun.pphoto}" style="width:100px;heigth:100px"></td>
            <td>${pinglun.ptime}</td>
            <td><a href="/dcxy/item?id=${pinglun.cid}">评论所在页面</a></td>
            <td>${pinglun.neirong}</td>            
            <td><a href="/dcxy/deletepinglun?Pid=${pinglun.id}" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>           
         </tr>
</c:forEach>
    </tbody>
</table>
