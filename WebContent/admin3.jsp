...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">菜名</th>
    ...
    <c:forEach items="${list}" var="order">
    	<tr>
        	...
        	<td>${order.status}</td>
        	<td>${order.date}</td>
           <td><a href="/dcxy/deldd?orderId=${order.id}" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td></tr>          
     </c:forEach>
    <td colspan="7"><p style="float:right">总营业额：${sumprice}</p></td>
  </tbody>
</table>
