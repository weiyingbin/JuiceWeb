							...
							<div class="box p-40 p-xs-20 bg-white">
								<form action="doRegister.action" method="post">
									<div class="form-group">
										...
										<input type="text" name="username" value="" placeholder="Last Name" id="input-last-name" class="form-control form-item">
									</div>
									<div class="form-group">
									...
									<div class="m-t-15"> 
									<input type="checkbox" name="agree" class="m-r-10" value="1"> 我阅读并接受协议 
