							...
							<div class="box p-40 p-xs-20 bg-white">
								<form action="modifyUser.action" method="post">
									<div class="form-group">
										<label class="control-label" for="input-email">姓名</label>
										<input type="text" name="usname" value="${modiuser.name}"  id="input-last-name" class="form-control form-item">
									</div>
									<div class="form-group">
										<label class="control-labe" for="input-email">邮箱</label>
										<input type="text" name="usemail" value="${modiuser.email}" id="input-email" class="form-control form-item">
									</div>
									<div class="form-group">
										<label class="control-label" for="input-email">电话</label>
										<input type="text" name="usphone" value="${modiuser.phone}"  id="input-phone" class="form-control form-item">
									</div>
									<div class="form-group">
										<label class="control-label" for="input-password">收货地址</label>
										<input type="text" name="address" value="${modiuser.address}"  id="input-password" class="form-control form-item">
									</div>
									
									<input type="submit" class="btn ht-btn bg-6 m-t-30" value="修改" />
